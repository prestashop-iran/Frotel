...
include(dirname(__FILE__).'/override/AdminProducts.php'); // me
include(dirname(__FILE__).'/override/fa.php'); // me
...
class AdminCatalog extends AdminTab
{
    ...
    public function l($string){
        global $_LANGADM;
        if(!empty($_LANGADM['AdminCatalog'.md5($string)]))
            return $_LANGADM['AdminCatalog'.md5($string)];
