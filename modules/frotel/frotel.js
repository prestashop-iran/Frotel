...
$('input[name*="city"]').after('<select name="city" id="city"><option value="0">لطفاً استان را انتخاب کنيد</option></select>');
...
options[2]=new Option(" بشرويه","6-بشرويه");
options[3]=new Option(" خضري","8-خضري");
